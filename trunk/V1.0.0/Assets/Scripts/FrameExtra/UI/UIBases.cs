...
public abstract class UIBases : UIBase
{
   ...
   public void Awake()
    ...
    void AddBehaviours(Transform root)
    {
        ...
        for (int i = 0; i < root.childCount; i++)
        {
            ...
            else
            {
                ...
                {
                    UIBehaviours behav = tmpChild.GetComponent<UIBehaviours>();
                    if (behav == null)
                    {

                        behav = tmpChild.gameObject.AddComponent<UIBehaviours>();
                        behav.PanelName = panelName;
                    }
                }
    ...
    public T GetUIComponent<T>(string panelName, string objName)
    {
        Debug.Log("panelName==" + panelName + "objNanme==" + objName);
        return GetGameObject(panelName,objName).GetComponent<T>();
    }
    ...
    public T AddComponetToChild<T>(string panelName, string objName) where T : Component
    {

        GameObject tmpObj = GetGameObject(panelName, objName);
    ...
    public void AddButtonLisenter(string panelName, string objName, UnityAction action)
    {


        UIBehaviours tmpBehavrours = GetUIComponent<UIBehaviours>(panelName, objName);
    ...
    public void AddButtonDownLisenter(string panelName, string objName, UnityAction<BaseEventData> action)
    {
        UIBehaviours tmpBehavrours = GetUIComponent<UIBehaviours>(panelName, objName);
    ...
    public void AddButtonUpLisenter(string panelName, string objName, UnityAction<BaseEventData> action)
    {
        UIBehaviours tmpBehavrours = GetUIComponent<UIBehaviours>(panelName, objName);
    ...
    public void AddSliderLisenter(string panelName, string objName, UnityAction<float> action)
    {
        UIBehaviours tmpBehavrours = GetUIComponent<UIBehaviours>(panelName, objName);
    ...
    public void AddInputFiledLisenter(string panelName, string objName, UnityAction<string> action)
    {
        UIBehaviours tmpBehavrours = GetUIComponent<UIBehaviours>(panelName, objName);
    ...
    public void AddToggleLisenter(string panelName, string objName, UnityAction<bool> action)
    {
        UIBehaviours tmpBehavrours = GetUIComponent<UIBehaviours>(panelName, objName);
