...
{
    [MenuItem("Assets/Create/U3DEventFrame Lua View Script", false, 80)]
    ...
    [MenuItem("Assets/Create/U3DEventFrame Lua Control or Model Script", false, 80)]
    public static void CreatNewLuaControl()
    {
        ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0,
        ScriptableObject.CreateInstance<CreateLuaScriptAsset>(),
        GetSelectedPathOrFallback() + "/New Lua.lua",
        null,
       "Assets/Scripts/Editor/LuaCMClass.lua");
    }
